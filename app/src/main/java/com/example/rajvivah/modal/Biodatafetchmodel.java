...
public class Biodatafetchmodel {
    ...
    candidate_state,
    candidate_country,
    candidate_polstation,
    candidate_pin,
    candidate_name_of_fatherinlaw,
    candidate_cast_of_fatherinlaw,
    candidate_gotra_of_fatherinlaw,
    candidate_address_of_fatherinlaw,
    candidate_post_of_fatherinlaw,
    candidate_teh_of_fatherinlaw,
    candidate_polstation_of_fatherinlaw,
    candidate_dist_of_fatherinlaw,
    candidate_state_of_fatherinlaw,
    candidate_country_of_fatherinlaw,
    candidate_pin_of_fatherinlaw,
    candidate_name_of_nanosa,
    candidate_cast_of_nanihal,
    candidate_gotra_of_nanihal,
    candidate_address_of_nanihal,
    candidate_post_of_nanihal,
    candidate_teh_of_nanihal,
    candidate_polstation_of_nanihal,
    candidate_dist_of_nanihal,
    candidate_state_of_nanihal,
    candidate_country_of_nanihal,
    candidate_pin_of_nanihal,
    candidate_name_of_dadera,
    candidate_cast_of_dadera,
    candidate_gotra_of_dadera,
    candidate_address_of_dadera,
    candidate_post_of_dadera,
    candidate_teh_of_dadera,
    candidate_polstation_of_dadera,
    candidate_dist_of_dadera,
    candidate_state_of_dadera,
    candidate_country_of_dadera,
    candidate_pin_of_dadera,
    tenth_board,
    tenth_per,
    twelth_board,
    tenth_sub,
    ...
    updatemode,
    lasteducation,
    lasteducation_edu_per,
    lasteducation_edu_sub;
   ...
   int candidate_son,  register_uid,   candidate_daughter;
    ...
    public void setRegbyId(String regbyId) {
        this.regbyId = regbyId;
    }
    ...
    public String getLasteducation_edu_per() {
        return lasteducation_edu_per;
    }

    public void setLasteducation_edu_per(String lasteducation_edu_per) {
        this.lasteducation_edu_per = lasteducation_edu_per;
    }

    public String getLasteducation_edu_sub() {
        return lasteducation_edu_sub;
    }

    public void setLasteducation_edu_sub(String lasteducation_edu_sub) {
        this.lasteducation_edu_sub = lasteducation_edu_sub;
    }
    ...
    public void setRegister_uid(int register_uid) {
        this.register_uid = register_uid;
    }
    ...
    public void setIsmanglik(Boolean ismanglik) {
        this.ismanglik = ismanglik;
    }
}
