...
public class Activity_Biomatrix extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_biomatrix);
        ...
        final BiometricPrompt biometricPrompt = new BiometricPrompt(Activity_Biomatrix.this, executor, new BiometricPrompt.AuthenticationCallback() {
            @Override
